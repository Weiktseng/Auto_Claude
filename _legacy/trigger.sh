#!/bin/bash
#
# Auto_Claude Reviewer Trigger
# 通用 AI 審查者（Reviewer）觸發器
#
# Usage:
...
#     --prompt-template ./agent/prompts/motc_reviewer.prompt.md
#
...
if [[ -z "$PROMPT_TEMPLATE" ]]; then
    PROMPT_TEMPLATE="$SCRIPT_DIR/prompts/motc_reviewer.prompt.md"
fi
...
echo "🤖 Auto_Claude Reviewer Trigger"
...
# ── Step 5: Call claude ──
echo "🧠 Calling Claude reviewer ($MODEL)..."
echo ""
...
echo ""
echo "✅ Reviewer trigger complete. (${DURATION}s)"
echo "📄 Log: $LOG_FILE"
